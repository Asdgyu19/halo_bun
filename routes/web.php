...
Route::post('/threads', [FrontThread::class,'store'])->middleware('auth');
Route::post('/threads/{thread}/comment', [FrontThread::class,'comment'])->middleware('auth');
...
Route::get('/profile', [FrontProfile::class,'show'])->middleware('auth');
Route::put('/profile', [FrontProfile::class,'update'])->middleware('auth');
